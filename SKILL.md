...
description: "Use when building, implementing, or refactoring frontend UI — components, pages, design systems, responsive layouts, or any visual work that follows a design language. Use when integrating design tokens, writing CSS custom properties, implementing dark mode, or auditing visual consistency. Trigger phrases: '帮我写一个卡片组件'、'实现这个设计'、'接入 design tokens'、'修复布局在手机上显示不对'、'帮我做 dark mode'、'检查一下这个页面的无障碍'"
version: 0.1.0
---

# Kold Frontend Design Skill

When this skill is active, every visual artifact you produce must be precise, token-driven, accessible, and consistent with the established design language.
